...
<title>FuelIn | Sign Up</title>
  ...
  <body style="background-image:url('images/headerimg1.jpg');">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="customer_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            <label for="fullname"><span class="text-danger" style="margin-right: 5px;">*</span> NIC: </label>
            <div class="input-group">
              <input class="form-control" id="nic" type="text" name="nic" placeholder="Your NIC" required="" autofocus="">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="contact"><span class="text-danger" style="margin-right: 5px;">*</span> mobile: </label>
            <div class="input-group">
              <input class="form-control" id="mobile" type="text" name="mobile" placeholder="mobile" required="">
              <span class="input-group-btn">
