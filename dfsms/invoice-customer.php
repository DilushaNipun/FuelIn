...
<?php 
//Product Details
$query=mysqli_query($con,"select tblpayments.Customer_NIC,tblpayments.Token_ID,tblpayments.Payment_Amount from tblpayments where tblpayments.paymnet_ID='$inid'");
$cnt=1;
while($row=mysqli_fetch_array($query))
{    
?>                                                
