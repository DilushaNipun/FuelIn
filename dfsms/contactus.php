...
<html>
  ...
  <head>
    <title> Contact | FuelIn </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="dist/css/contactus.css">
...
?>
    ...
    <div class="heading" >
     <strong>Want to contact <span class="edit"> Speedy Foods </span>?</strong>
     <br>
    ...
    <div class="container" style="background-image:url('images/headerimg1.jpg'); background-size: 100%">
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <input type="submit" name="submit" type="button" id="submit" name="submit" class="btn btn-primary pull-right" button onclick="myalert()"/>    
        </form>
