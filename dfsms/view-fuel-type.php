...
<li class="breadcrumb-item"><a href="#">Fuel Types</a></li>
...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>View Fuel Type</h4>
                </div>
                <!-- /Title -->
